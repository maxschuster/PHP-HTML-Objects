...
use de\maxschuster\pho\tag\Html;
use de\maxschuster\pho\tag\Head;
use de\maxschuster\pho\tag\Body;
use de\maxschuster\pho\tag\Title;
use de\maxschuster\pho\doctype\DocType;
use de\maxschuster\pho\tag\Meta;
use de\maxschuster\pho\tag\Script;
use de\maxschuster\pho\tag\ext\LinkStylesheet;
use de\maxschuster\pho\doctype\XHtml10Transitional;
use de\maxschuster\pho\tag\Link;
use de\maxschuster\pho\exception\UnknownMimeTypeException;
