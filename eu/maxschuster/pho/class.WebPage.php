...
use eu\maxschuster\pho\tag\Html;
use eu\maxschuster\pho\tag\Head;
use eu\maxschuster\pho\tag\Body;
use eu\maxschuster\pho\tag\Title;
use eu\maxschuster\pho\doctype\DocType;
use eu\maxschuster\pho\tag\Meta;
use eu\maxschuster\pho\tag\Script;
use eu\maxschuster\pho\tag\ext\LinkStylesheet;
use eu\maxschuster\pho\doctype\XHtml10Transitional;
use eu\maxschuster\pho\tag\Link;
use eu\maxschuster\pho\exception\UnknownMimeTypeException;
